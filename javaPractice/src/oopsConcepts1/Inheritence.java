...
public class Inheritence extends Vehicle {
	  ...
	  public static void main(String[] args) {
	    ...
	    // Create a myCar object
		  Inheritence myCar = new Inheritence();
 ...
 * 
 * subclass (child) - the class that inherits from another class superclass
 * (parent) - the class being inherited from To inherit from a class, use the
 * extends keyword.
 * 
